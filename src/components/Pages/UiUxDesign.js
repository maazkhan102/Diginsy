...
const UiUxDesign = () => {
  ...
  return (
    <>
    <div className='mainn20'>
   <div className="mainn-image20">
        <div className="containerr20">
            <span className="cenn20"> <span style={{color:"red"}}> UI / UX Designs that  </span>   <br></br> represent Excellence</span>
        </div>
    </div>
...
<div className='grid5s20'>
<div className='left5s20'>
<img  src='./bbb.png' alt='globe' />
</div>
<div className='right5s20'>
  <div className='right5scontent20'>
 <h1 style={{color:"white"}}>Quality-Assured Website Maintenance <br></br> Services</h1>
 <center>
        <div className="scroll20">
...
<div className='gridHowWeWork20'>
  <div className='gridHowWeWork120'>
  ...
  <div className='gridHowWeWork220'>
  <Card style={{ width: '17rem' , height:"27rem"}}>
      <Card.Img style={{width:"3rem", marginLeft:"20px", marginTop:"20px"}} variant="top" src="./HowWeWorkBook.png" />
      <Card.Img style={{width:"10rem", marginLeft:"40px"}} variant="top" src="./HowWeWorkArrow.png" />
      <Card.Text className='hov' style={{fontSize:"30px", fontWeight:"700" , border:"2px solid red", width:"240px" , backgroundColor:"red" , height:"80px", fontFamily:"sans-serif", color:"white"}} >
  ...
  <div className='gridHowWeWork320'>
  <Card style={{ width: '17rem' , height:"27rem"}}>
      <Card.Img style={{width:"3rem", marginLeft:"20px", marginTop:"20px"}} variant="top" src="./HowWeWorkBook.png" />
      <Card.Img style={{width:"10rem", marginLeft:"40px"}} variant="top" src="./HowWeWorkArrow.png" />
      <Card.Text className='hov' style={{fontSize:"30px", fontWeight:"700" , border:"2px solid red", width:"240px" , backgroundColor:"red" , height:"80px", fontFamily:"sans-serif", color:"white"}} >
  ...
  <div className='gridHowWeWork420'>
  <Card style={{ width: '17rem' , height:"27rem"}}>
      <Card.Img style={{width:"3rem", marginLeft:"20px", marginTop:"20px"}} variant="top" src="./HowWeWorkBook.png" />
      <Card.Img style={{width:"10rem", marginLeft:"40px"}} variant="top" src="./HowWeWorkArrow.png" />
      <Card.Text className='hov' style={{fontSize:"30px", fontWeight:"700" , border:"2px solid red", width:"240px" , backgroundColor:"red" , height:"80px", fontFamily:"sans-serif", color:"white"}} >
