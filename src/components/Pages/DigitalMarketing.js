...
const DigitalMarketing = () => {
  ...
  return (
    <>
    <div className='mainn19'>
   <div className="mainn-image19">
        <div className="containerr19">
            <span className="cenn19"> <span style={{color:"red"}}>Prime Quality</span>  <br></br>
...
<div className='maingrids19'>
<div className='lefts19'>
<Carousel>
...
<div className='grid5s19'>
<div className='left5s19'>
<img  src='./bbb.png' alt='globe' />
</div>
<div className='right5s19'>
  <div className='right5scontent19'>
 <h1 style={{color:"white"}}>Quality-Assured Website Maintenance <br></br> Services</h1>
 <center>
        <div className="scroll19">
...
<div className='gridHowWeWork19'>
  <div className='gridHowWeWork119'>
  ...
  <div className='gridHowWeWork219'>
  <Card style={{ width: '17rem' , height:"27rem"}}>
      <Card.Img style={{width:"3rem", marginLeft:"20px", marginTop:"20px"}} variant="top" src="./HowWeWorkBook.png" />
      <Card.Img style={{width:"10rem", marginLeft:"40px"}} variant="top" src="./HowWeWorkArrow.png" />
      <Card.Text className='hov' style={{fontSize:"30px", fontWeight:"700" , border:"2px solid red", width:"240px" , backgroundColor:"red" , height:"80px", fontFamily:"sans-serif", color:"white"}} >
  ...
  <div className='gridHowWeWork319'>
  <Card style={{ width: '17rem' , height:"27rem"}}>
      <Card.Img style={{width:"3rem", marginLeft:"20px", marginTop:"20px"}} variant="top" src="./HowWeWorkBook.png" />
      <Card.Img style={{width:"10rem", marginLeft:"40px"}} variant="top" src="./HowWeWorkArrow.png" />
      <Card.Text className='hov' style={{fontSize:"30px", fontWeight:"700" , border:"2px solid red", width:"240px" , backgroundColor:"red" , height:"80px", fontFamily:"sans-serif", color:"white"}} >
  ...
  <div className='gridHowWeWork419'>
  <Card style={{ width: '17rem' , height:"27rem"}}>
      <Card.Img style={{width:"3rem", marginLeft:"20px", marginTop:"20px"}} variant="top" src="./HowWeWorkBook.png" />
      <Card.Img style={{width:"10rem", marginLeft:"40px"}} variant="top" src="./HowWeWorkArrow.png" />
      <Card.Text className='hov' style={{fontSize:"30px", fontWeight:"700" , border:"2px solid red", width:"240px" , backgroundColor:"red" , height:"80px", fontFamily:"sans-serif", color:"white"}} >
