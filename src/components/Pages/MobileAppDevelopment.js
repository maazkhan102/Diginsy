...
const MobileAppDevelopment = () => {
  ...
  return (
   <>
    <div className='mainn18'>
   <div className="mainn-image18">
        <div className="containerr18">
            <span className="cenn18"> <span style={{color:"red"}}> State-Of-The-Art</span>  Mobile App Development Services In USA <br></br></span>
        </div>
    </div>
...
<div className='maingrids18'>
<div className='lefts18'>
<Carousel>
...
<div className='grid5s18'>
<div className='left5s18'>
<img  src='./bbb.png' alt='globe' />
</div>
<div className='right5s18'>
  <div className='right5scontent18'>
 <h1 style={{color:"white"}}>Quality-Assured Website Maintenance <br></br> Services</h1>
 <center>
        <div className="scroll18">
...
<div className='gridHowWeWork18'>
  <div className='gridHowWeWork118'>
  <Card style={{ width: '17rem' , height:"27rem"}}>
      <Card.Img style={{width:"3rem", marginLeft:"20px", marginTop:"20px"}} variant="top" src="./" />
      <Card.Img style={{width:"10rem", marginLeft:"40px"}} variant="top" src="./HowWeWorkBook.png" />
  ...
  <div className='gridHowWeWork218'>
  <Card style={{ width: '17rem' , height:"27rem"}}>
  ...
  <div className='gridHowWeWork318'>
  <Card style={{ width: '17rem' , height:"27rem"}}>
      <Card.Img style={{width:"3rem", marginLeft:"20px", marginTop:"20px"}} variant="top" src="./HowWeWorkBook.png" />
      <Card.Img style={{width:"10rem", marginLeft:"40px"}} variant="top" src="./HowWeWorkArrow.png" />
      <Card.Text className='hov' style={{fontSize:"30px", fontWeight:"700" , border:"2px solid red", width:"240px" , backgroundColor:"red" , height:"80px", fontFamily:"sans-serif", color:"white"}} >
  ...
  <div className='gridHowWeWork418'>
  <Card style={{ width: '17rem' , height:"27rem"}}>
      <Card.Img style={{width:"3rem", marginLeft:"20px", marginTop:"20px"}} variant="top" src="./HowWeWorkBook.png" />
      <Card.Img style={{width:"10rem", marginLeft:"40px"}} variant="top" src="./HowWeWorkArrow.png" />
      <Card.Text className='hov' style={{fontSize:"30px", fontWeight:"700" , border:"2px solid red", width:"240px" , backgroundColor:"red" , height:"80px", fontFamily:"sans-serif", color:"white"}} >
